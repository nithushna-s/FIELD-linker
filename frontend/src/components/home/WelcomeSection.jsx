...
const WelcomeSection = () => {
  return (
    <>
      <Carousel style={{ fontFamily: 'Cutive Mono', fontSize: '3em' }}>
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={home} alt="Second slide" height={972} style={{opacity:'0.8'}}/>
      ...
      <section className="about" >
        <h2 className="section-subtitle">About Us</h2><br />
        <div className="container">
          <figure className="about-banner" style={{ marginBottom: '14%' }}>
            <img src={favicon} alt="Favicon" style={{ marginTop: '6%' ,height:'100%' }} />
          </figure>
          <div className="about-content">
            <h1 className=" section" style={ {textAlign:'justify'}}>Your Premier Marketplace for Cultivation Land Sales, Rental or Lease.</h1>
            <h3 className="about-text"><br />
              Seamlessly connecting cultivation landowners and seekers for a simplified renting and leasing experience. Your effortless journey into cultivating the land starts here.
            </h3><br /><br />
  ...
  <h2 className="section-subtitle">Discover Our Exceptional Services</h2><br /><br /><br /><br />
  <div className="row1">
    <div className="column1">
      <div className="card1">
        ...
        <p>
          Seamlessly unite landowners with eager land seekers, ensuring effortless transactions for both parties.
        </p>
      </div>
    </div>
    {/* <div className="column1">
      <div className="card1">
        ...
        <h3>Showcasing Available Lands</h3>
        <p>
          Present your pristine lands to potential cultivators, enabling them to discover the perfect plot for their dreams.
        </p>
      </div>
    </div> */}
    <div className="column1">
      <div className="card1">
        ...
        <p>
          Unlock opportunities for land leasing and renting, empowering landowners to monetize their assets and land seekers to find their ideal cultivation spaces.
        </p>
      </div>
    </div>
    <div className="column1">
      <div className="card1">
        ...
        <p>
          Elevate your land sales with our expert guidance. Our seasoned team ensures a seamless and lucrative sale process from start to finish.
        </p>
      </div>
    </div>
  </div>
