...
class SignUp extends Component {
  ...
  render() {
    const { isFormValid, validationErrors, isPasswordVisible } = this.state;
      ...
      <>
        ...
        <form onSubmit={this.handleSubmit} style={authInnerStyle}>
          ...
          <div className="d-grid">
            <button type="submit" className="btn" style={{ padding: '6px', border: 'none', background: '#0A3C50' }}>
              Sign Up
            </button>
          </div>
          <br />
          <p className="forgot-password text-right" >
            Already registered <a href="/SignIn" style={{display:'inline'}}>sign in?</a>
          </p>
          {!isFormValid && (
