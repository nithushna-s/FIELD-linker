        ...
        <div className="container" >
          <div className="cta-card" style={{background:'white' ,color:'#137077'}}>
            <div className="card-content" >
              <p className="h2 card-title" style={{color:'#137077'}}>Cultivate Your Dreams with Us! </p>
              <p className="card-text" style={{color:'#137077'}}>Discover Prime Land For Rent Or Lease.</p>
            </div>
...
Explore Lands
  ...
  <li>
    <a href="mailto:contact@homeverse.com" class="contact-link" >
      ...
      <span>contact@Fieldlinker.com</span>
    </a>
  </li>
...
<ul class="footer-list">
  ...
  <li>
    <a href="/cultivatione-lands-Section" class="footer-link">All Cultivatione Lands</a>
  </li>
...
<ul class="footer-list">
  ...
  <li>
    <a href="/post-adform" class="footer-link" >Providing Land For Rent</a>
  </li>

  <li>
    <a href="/cultivatione-lands-Section" class="footer-link" > Renting Land</a>
  </li>
...
<ul class="footer-list">
  ...
  <li>
    <a href="/signin" class="footer-link" >Login</a>
  </li>
