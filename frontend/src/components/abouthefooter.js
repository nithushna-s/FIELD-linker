...
<ul class="footer-list">
  ...
  <li>
    <a href="#" class="footer-link">All Cultivatione Lands</a>
  </li>
...
<ul class="footer-list">
  ...
  <li>
    <a href="/post-adform" class="footer-link" >Providing Land</a>
  </li>

  <li>
    <a href="/AgrilandsSection" class="footer-link" > Renting Land</a>
  </li>
